...
public class ParadiseBlockPortal extends BlockPortal {
    public ParadiseBlockPortal(String key, int id, int targetDimension, int portalMaterialId, int portalTriggerId) {
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
        ...
        if ((meta & 2) > 0 && rand.nextInt(20) == 0) {
            world.playSoundEffect(SoundType.WORLD_SOUNDS, (double)x + 0.5, (double)y + 0.5, (double)z + 0.5, "liquid.water", 0.55F, rand.nextFloat() * 0.4F + 0.8F);
        }
